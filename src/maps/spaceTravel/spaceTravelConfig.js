...
const SpaceTravelConfig = {
    ...
    PORTAL_SEGMENTS: 32,
    PORTAL_RADIUS_Y_SCALE_MULT: 0.6,
    ...
    SHIP_WIREFRAME_SCALE_MULT: 50,
    SHIP_WIREFRAME_MIN_SCALE_AU: 0.0008,
    SHIP_WIREFRAME_MIN_SIZE_CHARS: 4.4,
    SHIP_WIREFRAME_MAX_SCREEN_SCALE_MULT: 440,
    SHIP_SPRITE_MAX_DISTANCE_AU: 1,
    SHIP_SPRITE_LARGE_MAX_DISTANCE_AU: null,
    SHIP_SPRITE_NOSE_BACK_THRESHOLD: 0.92,
    SHIP_SPRITE_SIDE_VIEW_MAX_ABS_Z: 0.3,
    SHIP_SPRITES,
    SHIP_SPRITES_LARGE,
    ...
    SHIP_FLASH_HULL_COLOR: '#ff00ff',    // Magenta for hull damage
    ...
    NPC_COMBAT_AIM_JITTER_AU: 0.006,
    PLAYER_COMBAT_AIM_JITTER_AU: 0.004,
    PLAYER_LASER_DRAW_FULL_PATH: true,
    NPC_COMBAT_LASER_VISIBLE_MS: 180,
    NPC_SHOT_MIN_DAMAGE: 2,
    NPC_SHOT_MAX_DAMAGE: 6,
    NPC_NON_HOSTILE_FIRE_WARNING_MS: 2000,

    // Asteroid fields
    ASTEROID_ENABLED: true,
    ASTEROID_BELT_PLAYER_ACTIVATION_AU: 1,
    ASTEROID_MAX_ACTIVE_COUNT: 80,
    ASTEROID_SPAWN_INTERVAL_MS: 300,
    ASTEROID_MAX_SPAWN_DISTANCE_FROM_PLAYER_AU: 1.25,
    ASTEROID_DESPAWN_DISTANCE_AU: 2.8,
    ASTEROID_SPAWN_PROGRESS_SPREAD: 0.035,
    ASTEROID_MAX_INCLINATION_DEG: 18,
    ASTEROID_RENDER_SCALE: 1,
    ASTEROID_FAR_SYMBOL_DISTANCE_AU: 1.2,
    ASTEROID_FAR_SYMBOL: '·',
    ASTEROID_ROCKY_RADIUS_MIN_AU: 0.0016,
    ASTEROID_ROCKY_RADIUS_MAX_AU: 0.0038,
    ASTEROID_ICY_RADIUS_MIN_AU: 0.0018,
    ASTEROID_ICY_RADIUS_MAX_AU: 0.0042,
    ASTEROID_KUIPER_TARGET_COUNT: 14,
    ASTEROID_OORT_TARGET_COUNT: 16,
    ...
    DEBUG_SHIP_WIREFRAME_LOG: true,
    DEBUG_SHIP_WIREFRAME_LOG_EVERY_MS: 0,
    DEBUG_LASER_LOG: true,
    DEBUG_NPC_LASER_LOG: true,
    DEBUG_ROLL_LOG: true,
