...
const SpaceTravelRender = (() => {
    ...
    function render(params) {
        ...
        if (params.config.ASCII_LOG_INTERVAL_MS && (!params.lastAsciiLogTimestamp || (Date.now() - params.lastAsciiLogTimestamp) >= params.config.ASCII_LOG_INTERVAL_MS)) {
            params.lastAsciiLogTimestamp = Date.now();
