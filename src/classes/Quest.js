...
class Quest {
     ...
     * @param {number} expReward - Experience points awarded on completion
     ...
     */
    constructor(id, name, description, creditReward, expReward, checkCompleted, messageOnComplete = null, relatedSystems = [], getQuestProgress = null, questProgressLabel = null) {
        this.id = id;
        this.name = name;
