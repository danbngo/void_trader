...
const AVERAGE_SHIP_VALUE = 10*1000
const AVERAGE_SHIP_HULL = 20
const AVERAGE_SHIP_SHIELDS = 10
const AVERAGE_SHIP_CARGO = 20
const AVERAGE_SHIP_FUEL = 10
const AVERAGE_SHIP_ENGINE = 10
const AVERAGE_SHIP_LASER = 10
const AVERAGE_SHIP_RADAR = 10
...
const ENEMY_USE_ITEM_PER_TURN_CHANCE = 0.25
const ENEMY_MAX_ITEM_USE_DURING_COMBAT = 1
const ENEMY_DROP_ITEM_CHANCE = 0.25
