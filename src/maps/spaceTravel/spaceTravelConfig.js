...
const SpaceTravelConfig = {
    ...
    SHIP_SPEED_PER_ENGINE: 1 / 60,
    SHIP_ACCEL_PER_ENGINE: 0.08,
    TURN_DEG_PER_SEC: 90,

    TIME_SCALE_GAME_SECONDS_PER_REAL_SECOND: 60,
    GAME_SECONDS_PER_DAY: 86400,

    SYSTEM_BODY_SCREEN_SCALE: 1,
    ...
    DUST_PARTICLE_LINE_SYMBOLS: false,
    DUST_PARTICLE_LINE_SPEED_THRESHOLD: 0.125,
