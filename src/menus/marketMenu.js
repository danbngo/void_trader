...
const MarketMenu = (() => {
    ...
    function render(onReturn) {
        ...
        // Title
        UI.addTitleLineCentered(0, `${currentSystem.name}: Market`);
        ...
        TableRenderer.renderKeyValueList(5, 2, [
            ...
            { label: 'System Fees:', value: `${(currentSystem.fees * 100).toFixed(1)}%`, valueColor: COLORS.TEXT_NORMAL },
            { label: 'Fees after Barter:', value: `${(effectiveFees * 100).toFixed(1)}%`, valueColor: COLORS.TEXT_NORMAL }
        ]);
