...
const SpaceTravelConfig = {
    ...
    SHIP_EDGE_GLYPH_POSTPROCESS: true,
    SHIP_EDGE_GLYPH_OUTSIDE: true,
    SHIP_EDGE_GLYPH_DEPTH_EPS: 0.002,
    SHIP_EDGE_GLYPH_ANGLE_BINS: 96,
    SHIP_EDGE_GLYPH_RADIAL_TOLERANCE: 0.35,
    SHIP_EDGE_GLYPH_OUTSIDE_RADIAL_ALLOWANCE: 0,
    SHIP_GLYPH_SINGLE_STAGE: true,
    SHIP_GLYPH_INVARIANTS: true,
    SHIP_GLYPH_DISALLOW_ADJACENT_SAME_TRIANGLE: true,
    SHIP_GLYPH_DEBUG: false,
    SHIP_GLYPH_DEBUG_LOG_EVERY_MS: 500,
